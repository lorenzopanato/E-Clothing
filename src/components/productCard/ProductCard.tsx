...
export default function ProductCard({ product }: { product: IProduct }) {
  ...
  return (
    <div
      ...
      className={`w-64 rounded ${location.pathname === "/" && "xl:w-72"} px-4 pt-2 pb-4 flex flex-col cursor-pointer transition-shadow hover:shadow-md`}
    >
      <div className={`h-64 ${location.pathname === "/" && "xl:h-80"} flex items-center justify-center overflow-hidden`}>
        <img
          src={product.image}
